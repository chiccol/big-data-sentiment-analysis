...
from models.postgres_models import AggregatedPostgresResponse
...
# THIS FUNCTION GETS DATA AGGREGATED JUST BY DAY
@router.get("/aggregated-postgres-data/{company}",
